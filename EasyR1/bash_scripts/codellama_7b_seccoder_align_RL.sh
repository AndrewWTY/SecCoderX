...
RAY_CPUS=${RAY_CPUS:-8} CUDA_VISIBLE_DEVICES=$DEVICES python3 -m verl.trainer.main \
    ...
    data.train_files=SecCoderX/SecCoderX_CodeLlama_7b_GRPO_dataset\
    data.val_files=SecCoderX/SecCoderX_CodeLlama_7b_GRPO_dataset\
    worker.actor.model.model_path=meta-llama/CodeLlama-7b-Instruct-hf \
