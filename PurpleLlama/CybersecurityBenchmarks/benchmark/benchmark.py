...
class BenchmarkConfig:
    ...
    judge_batch_auto: bool = False
    judge_api_key: Optional[str] = None
    judge_batch_limit: Optional[int] = None
...
class Benchmark(ABC):
    ...
    def __init__(
        ...
        self.judge_batch: bool = config.judge_batch
        self.judge_batch_auto: bool = config.judge_batch_auto
        self.judge_api_key: Optional[str] = config.judge_api_key
        self.judge_batch_limit: Optional[int] = config.judge_batch_limit
        self.judge_model: Optional[str] = config.judge_model
        self.reference_model: Optional[str] = config.reference_model
